...
print('Distance (m)', '  Verticle Cover (deg)  ', 'Horizontal Cover (deg)')

for i in range(0, meters):
    print("       ",i+1,"        ",round(soft_angle(triangle_angle(flec_x, i+1)),4),"            ",round(soft_angle(triangle_angle(flec_y, i+1)),4))
